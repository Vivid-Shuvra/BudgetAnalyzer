...
public class DataHandle1 extends JFrame implements ActionListener{

	private Container con;
	private Font font, f;
	private JLabel lab1, lab2, lab3, lab4, lab5,bgLab;
	private JTextField tf1, tf2, tf3, tf4;
	private JButton addbtn, updatebtn, deletebtn, clearbtn, savebtn; 
	...
	DataHandle1()
	{
		...
		lab1 = new JLabel("Add Revenue Information Here..");
		...
		addbtn.setBounds(480, 40, 100, 30);
		addbtn.setCursor(cursor);
		con.add(addbtn);
		
		updatebtn = new JButton("Update");
		updatebtn.setBounds(480, 80, 100, 30);
		updatebtn.setCursor(cursor);
		con.add(updatebtn);
		
		deletebtn = new JButton("Delete");
		deletebtn.setBounds(480, 120, 100, 30);
		deletebtn.setCursor(cursor);
		con.add(deletebtn);
		
		clearbtn = new JButton("Clear");
		clearbtn.setBounds(480, 160, 100, 30);
		clearbtn.setCursor(cursor);
		con.add(clearbtn);
		
		savebtn = new JButton("Save");
		savebtn.setBounds(480, 200, 100, 30);
		...
		else if(e.getSource() == savebtn)
		{
			...
			String percentage = p_Number; 
			 ...
			 try {
			     ...
			     String sql = "insert into revdata" + "(type, item, amount, percentage)" + "values(?, ?, ?,?)";
